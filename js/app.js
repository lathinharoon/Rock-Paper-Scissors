...
function caffetie() {
    ...
    function Conf() {
        ...
        this.terminalVelocity = rand(1.5, 2.5) * confettiParams.terminalVelocity;
    ...
    addConfetti();
    setTimeout(addConfetti, 700 + Math.random() * 170);
    setTimeout(addConfetti, 700 + Math.random() * 170);
...
function game(input) {
    ...
    switch (input+comp) {
        case "rr":
            ...
            setTimeout(() =>rock_div.classList.remove('grey-glow'),500);
            break;
        case "rp":
